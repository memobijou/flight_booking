...
urlpatterns = [
    ...
    path('cheap-flight/', TemplateView.as_view(template_name="flightairline/cheap_flight/cheap_flight.html"),
         name="cheap_flight"),
    path('airline/', TemplateView.as_view(template_name="flightairline/airline/airline.html"), name="airline"),
    path('flight/', TemplateView.as_view(template_name="flightairline/flight/flight.html"), name="flight"),
    path('privacy-policy/', TemplateView.as_view(template_name="flightairline/privacy_policy/privacy_policy.html"),
         name="privacy_policy"),
    path('impressum/', TemplateView.as_view(template_name="flightairline/impressum/impressum.html"),
         name="impressum"),
